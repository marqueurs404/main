...
public class CacheFileNames {
    ...
    public static final String MODULES = CACHE_FOLDER_PATH + NUSMODS_FOLDER_PATH + "modules";
    public static final String MODULES_SUMMARY = CACHE_FOLDER_PATH + NUSMODS_FOLDER_PATH + "modules_summary";
    public static final String HOLIDAYS = CACHE_FOLDER_PATH + NUSMODS_FOLDER_PATH + "holidays";
    public static final String ACADEMIC_CALENDAR = CACHE_FOLDER_PATH + NUSMODS_FOLDER_PATH + "academic_calendar";
