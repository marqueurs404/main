...
The application makes use of data from https://api.nusmods.com/v2/[NUSMods API] to allow users to generate their schedules based on their NUSMods timetable (`AddNusModsCommand`) or individual NUS modules (`AddNusModCommand`).
