...
The `select` command works when view a group's schedule, person's schedule or home page! The format for this command's
...
image::ugalvin/selectpopup.png[width=100%]
...
image::ugalvin/select1.png[width=100%]
...
image::ugalvin/select2.png[width=100%]
...
image::ugalvin/select3.png[width=100%]
